          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-4 p-4 border border-gray-300 rounded-md bg-gray-50">
              <p className="text-gray-700">
                ...
                <br />
                NIST has updated its password guidelines to prioritize
                simplicity and security. <br />
                <b>Forget complex rules and focus on length.</b>
                <ul className="list-disc pl-5">
                  <li>
                    <b>Length is Key:</b> Aim for at least {minLength}{" "}
                    characters, the longer the better.
                  </li>
                  <li>
                    <b>Creative Freedom:</b> Use any printable characters:
                    letters, numbers, symbols, spaces, emojis 😁, or other
                    languages (אפילו עברית).
                  </li>
                  <li>
                    <b>Unique and Unpredictable:</b> Avoid dictionary words,
                    personal information, or anything related to the app or
                    service.
                  </li>
                  <li>
                    <b>Memorability Matters:</b> Use memorable passphrases that
                    are easy for you to remember but difficult for others to
                    guess.
                  </li>
                </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <InfoCard title="HIBP (Have I Been Pwned)">
              <p className="text-gray-600">
                HIBP checks if your password appears in known data breaches.
                This is in compliance with NIST guidelines, which recommend
                checking passwords against known breach databases to prevent
                reuse of compromised credentials. Avoid using passwords found in
                such databases to enhance security.
              </p>
            </InfoCard>
            ...
            <InfoCard title="NIST Guidelines (SP 800-63B)">
              <ul className="list-disc pl-5 text-gray-600">
                ...
                <li>
                  Passwords must be at least 8 characters long (15 characters or
                  more recommended).
                </li>
                <li>Allow passwords up to at least 64 characters.</li>
                <li>Support all printable ASCII characters and spaces.</li>
                <li>
                  Unicode characters are recommended, with each code point
                ...
                <li>
                  Do not require periodic password changes unless there is
                  evidence of compromise.
                </li>
                <li>
                  Do not allow password hints accessible to unauthenticated
                  users.
                </li>
                <li>
                  Avoid using knowledge-based authentication (KBA) as part of
                  password verification.
                </li>
                <li>
                  Always validate the full password as submitted; do not
